...
public class BibliotecarioTest {
	...
	private static final String NOMBRE_USUARIO = "Saaibi Florez";
	...
	public void prestarLibroPalindromoTest() {
		...
		try {
			...
			// assert
			Assert.assertEquals(Bibliotecario.LOS_LIBROS_PALINDROMOS_SOLO_SE_PUEDEN_UTILIZAR_EN_BIBLIOTECA,
					e.getMessage());
		}
	}
}
